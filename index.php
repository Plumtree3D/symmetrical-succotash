...
<body id="body">
    ...
    <div class="sectionTitle" id="scroll01"> 
        <h2 class="sticker" data-text="About me"> 
            ...
            <div class="column">
                ...
                <p class= "mainText fr">
                    Salut! Moi c'est Céleste, j'apprends le developement web et web mobile à l'Acces Code School de Lons-Le-Saunier.
                </p>
                <p class="mainText en">
                    Independant and extremely driven, I am always eager to push the boundaries of my knowledge and I come to my ends more often than not. On the other hand I also know how to take and follow criticism with good faith and an open mind.
                </p>
                <p class="mainText fr">
                    Autonome et flexible, j'arrive souvent à mes fins avec juste assez de temps et de détermination, mais je sais aussi accepter l'échec et la critique en bonne foi sans jamais abandonner.
                </p>
            </div>
            <div>
                <div class="projectsWindow">
                    ...
                    <div class="innerWindow">
                        <p class="en"> I've had the occasion to work on several web development projects, giving me the opportunity to blablah </p>
                        <p class="fr"> Durant ma formation, j'ai eu l'occasion de travailler sur de nombreux projets et d'acquérir blablabla </p>
                        <a href="#" class="pixel buttonLink en"> OK, SHOW ME THE STUFF! </a>
                        <a href="#" class="pixel buttonLink fr"> OK MAIS MONTRE ! </a>
                    </div>
            </div>   
                        <p class="mainText jack en">
                            I like art! <br> Especially music, I have been playing drums and bass guitar for quite a few years now and I also enjoy sewing as well as 3D art and animation. 
                        </p>
                        <p class="mainText jack fr">
                           Je m'interesse à plein de choses! <br> Surtout la musique, je joue de la basse et de la batterie depuis maintenant quelques années mais j'aime également coudre et je fais de la modélisation 3D.
                        </p>
    ...
    <h2 class="sticker" id="scroll02" data-text="Get in touch"> 
    ...
    <a id="github" href="https://github.com/Plumtree3D" target="blank"><img src="images/github.svg" alt="Link to my GitHub"></a>
    <span class="linkedinTxt en"> Or fetch me on linkedIn ?</span>
    <span class="linkedinTxt fr"> Ou retrouve moi sur LinkedIn...</span>
    <a id="linkedin" href="https://www.linkedin.com/in/c%C3%A9leste-robert-casals/" target="blank"><img src="images/linkedin.svg" alt="Link to my LinkedIn"></a>
    ...
    function nightmode() {
        ...
        if (nightmodeCheckBox.checked == true) {
            if (window.matchMedia("(min-width: 1023px)").matches) {
                ...
                document.getElementById("header").style.cssText = "background: black"
            ...
            if (window.matchMedia("(min-width: 1023px)").matches) {
                ...
                document.getElementById("header").style.cssText = "background: white url(images/cable.svg) no-repeat right top;";
